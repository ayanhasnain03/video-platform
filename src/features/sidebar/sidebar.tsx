                  ...
                  <div className={cn("flex w-full flex-col gap-1")}>
                    ...
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && <p className="ml-2 text-sm font-medium">Home</p>}
                      </motion.li>
                    </Link>
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5 transition hover:bg-muted hover:text-primary",
                        pathname?.includes("explore") && "bg-muted text-blue-600",
                      )}
                    >
                      <Compass className="h-4 w-4" />
                      <motion.li variants={variants}>
                        {!isCollapsed && <p className="ml-2 text-sm font-medium">Explore</p>}
                      </motion.li>
                    </Link>
                    <Link
                      href="/categories"
                    ...
                    >
                      <div>🔥</div>
                      <motion.li variants={variants}>
                        {!isCollapsed && <p className="ml-2 text-sm font-medium">Trending</p>}
                      </motion.li>
                    </Link>
                    <Separator className="w-full" />
                    <Link
                    ...
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && <p className="ml-2 text-sm font-medium">Category</p>}
                      </motion.li>
                    </Link>
                    <Link
                      href="/feedback"
